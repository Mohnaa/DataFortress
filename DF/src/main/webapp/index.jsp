...
<%@ page import="com.example.df.helper.ConnectionProvider" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8" />
...
<nav
    ...
    <div class="container">
        ...
        <button
                ...
                aria-expanded="false" aria-label="Toggle navigation" justify-content="center">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item mx-0 mx-lg-1"><a
                        class="nav-link py-3 px-0 px-lg-3 rounded" href="register.jsp">Signup</a></li>
    ...
    <header class="masthead bg-primary text-white text-center" >
        <div class="container d-flex align-items-center flex-column" >
            ...
            <img class="masthead-avatar mb-5" src="assets/img/avataaars.svg"
                 alt="..." />
            <!-- Masthead Heading-->
            <h1 class="masthead-heading text-uppercase mb-0">Welcome to Data Fortress</h1>
            <!-- Icon Divider-->
            ...
            <!-- Masthead Subheading-->
            <p class="masthead-subheading font-weight-light mb-0">We focus on your privacy.  Your data security is our priority </p>
        </div>
    </header>
</section>
</br></br>
